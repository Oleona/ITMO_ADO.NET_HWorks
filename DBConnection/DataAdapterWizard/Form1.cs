...
namespace DataAdapterWizard
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            sqlDataAdapter1.RowUpdating += new SqlRowUpdatingEventHandler(RowUpdating);
            sqlDataAdapter1.RowUpdated += new SqlRowUpdatedEventHandler(RowUpdated);
            sqlDataAdapter1.FillError += new FillErrorEventHandler(FillError);
        }
